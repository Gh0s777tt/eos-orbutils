...
This is a **type-C fork** of [`https://gitlab.redox-os.org/redox-os/orbutils.git`](https://gitlab.redox-os.org/redox-os/orbutils.git). Read [`CLAUDE.md`](CLAUDE.md) first — the
